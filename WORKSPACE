...
#    urls = [
#	"https://github.com/golang/mod/archive/v0.4.1.tar.gz"
#    ],
#)
...
go_repository(
    ...
    sum = "h1:yVqYLShwENx8CB3IR3Jl2mC4mDfgVK9YaBP3tjYAxtI=",
    version = "v2.6.0",
)

git_repository(
    name = "bazel_mockery",
    commit = "b51ee14a4f29659732713c976a3330e47e61f9b4",
    remote = "git@github.com:chickenandpork/bazel_mockery.git",
)
#local_repository(
#    name = "bazel_mockery",
#    path = "/Users/allanc/src/bazel_mockery",
#)
